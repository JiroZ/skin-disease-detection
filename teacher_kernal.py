...
csv_path_train = '/kaggle/input/isic2020-tfrec-256x256-inpainted2/train_final2.csv'
trainImagePath = '/kaggle/input/isic2020-256x256-jpg/stratified_jpg_256/train0/%s.jpg'
...
for i, k in enumerate(imgs):
    img = cv2.imread(trainImagePath % k)
...
def get_InceptionResNetV2(dim=128):
    ...
    loss = tfa.losses.SigmoidFocalCrossEntropy(alpha=0.90, gamma=2.0, reduction=tf.keras.losses.Reduction.AUTO)
